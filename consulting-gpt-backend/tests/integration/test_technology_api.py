...
class TestTechnologyAPIIntegration:
    ...
    def test_create_technology_integration(self, client: TestClient):
        ...
        technology_data = {
            ...
            "num_of_axes": 3,
            "number_of_related_patents": 15,
            "number_of_related_papers": 20
        }
        ...
        assert data["number_of_related_patents"] == 15
        assert data["number_of_related_papers"] == 20

    def test_create_technology_with_defaults(self, client: TestClient):
        """Test creating a technology with default patent/paper counts"""
        technology_data = {
            "name": "Default Test Technology",
            "abstract": "A technology created with default values",
            "num_of_axes": 5
        }
        ...
        assert data["name"] == technology_data["name"]
        assert data["abstract"] == technology_data["abstract"]
        assert data["num_of_axes"] == 5
        # Should use default values
        assert data["number_of_related_patents"] == 10
        assert data["number_of_related_papers"] == 10
