...
class PatentService:
    ...
    async def search_patents(self, technology_id: int, search_query: str, max_results: int = 10) -> Optional[PatentSearch]:
        """
        ...
        Args:
            ...
            max_results: Maximum number of patents to retrieve (default: 10)
        ...
        try:
            ...
            # Keep fetching pages until we hit max_results or run out of pages
            while total_results < max_results:
                ...
                # Process results
                organic_results = search.get("organic_results", []) or []
                ...
                serpapi_pagination = search.get("serpapi_pagination", {}) or {}
