...
class Technology(Base):
    ...
    number_of_related_patents = Column(Integer, default=10)  # Number of patents to search for
    number_of_related_papers = Column(Integer, default=10)  # Number of papers to search for
